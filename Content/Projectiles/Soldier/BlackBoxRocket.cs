...
{
    public class BlackBoxRocket : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                int amount = (int)(0.22222f * damage / p.classMultiplier * player.statLifeMax2 / 200f);
                amount = Utils.Clamp(amount, 0, (int)(player.statLifeMax2 * 0.1f));
                int healingAmount = amount;
            ...
            Projectile.damage = (int)(90 * p.classMultiplier);
        ...
        private void Explode()
        {
            ...
            SoundEngine.PlaySound(new SoundStyle("TF2/Content/Sounds/SFX/rocket_blackbox_explode1"), Projectile.Center);
            // Smoke Dust spawn
            for (int i = 0; i < 50; i++)
            {
        ...
        public override void OnHitPlayer(Player target, int damage, bool crit)
        {
            ...
            else
            {
                ...
                {
                    int amount = (int)(0.22222f * damage / Main.player[Projectile.owner].GetModPlayer<TF2Player>().classMultiplier * Main.player[Projectile.owner].statLifeMax2 / 200f);
                    amount = Utils.Clamp(amount, 0, (int)(Main.player[Projectile.owner].statLifeMax2 * 0.1f));
                    int healingAmount = amount;
