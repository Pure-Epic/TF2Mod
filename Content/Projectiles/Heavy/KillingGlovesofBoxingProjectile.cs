...
namespace TF2.Content.Projectiles.Heavy
{
    ...
    public class KillingGlovesofBoxingProjectile : ModProjectile
    {
        /*
        ...
        */
        ...
        public override void SetStaticDefaults() => DisplayName.SetDefault("Fists");
        ...
        public override void AI()
        {
            ...
            if (Timer >= TotalDuration)
            {
                ...
                player.heldProj = Projectile.whoAmI; // Important so that the sprite draws "in" the player's hand and not fully infront or behind the player
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit) => Main.player[Projectile.owner].AddBuff(ModContent.BuffType<Buffs.HeavyCrit>(), 300);
    }
}
