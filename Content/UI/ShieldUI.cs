...
namespace TF2.Content.UI
{
    ...
    internal class ShieldUI : UIState
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            var modPlayer = Main.LocalPlayer.GetModPlayer<Items.Demoman.ShieldPlayer>();
            // Calculate quotient
            float quotient;
            if (!modPlayer.chargeActive)
            {
                quotient = (float)modPlayer.timer / Main.LocalPlayer.GetModPlayer<TF2Player>().shieldTimer; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
