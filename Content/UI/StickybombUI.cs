...
namespace TF2.Content.UI
{
    ...
    internal class StickybombUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            text = new UIText("Stickybomb Charge", 0.8f); // Text to show current value
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            // Calculate quotient
            float quotient = modPlayer.stickybombCharge / modPlayer.stickybombMaxCharge; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
