...
{
    public class DemomanBuddyNPC : Buddy
    {
        protected override Asset<Texture2D> Spritesheet => ModContent.Request<Texture2D>("TF2/Content/NPCs/Buddies/DemomanBuddyNPC");

        protected override Asset<Texture2D> SpritesheetReverse => ModContent.Request<Texture2D>("TF2/Content/NPCs/Buddies/DemomanBuddyNPC_Reverse");
        ...
        protected override void BuddyAttack(NPC target)
        {
            ...
            if (AttackTimer >= AttackSpeed && Ammo > 0)
            {
                ...
                float speed = 12.5f;
                int type = ModContent.ProjectileType<BuddyGrenade>();
