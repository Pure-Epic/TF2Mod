...
{
    public class SpyBuddyNPC : Buddy
    {
        protected override Asset<Texture2D> Spritesheet => ModContent.Request<Texture2D>("TF2/Content/NPCs/Buddies/SpyBuddyNPC");

        protected override Asset<Texture2D> SpritesheetReverse => ModContent.Request<Texture2D>("TF2/Content/NPCs/Buddies/SpyBuddyNPC");
        ...
        {
            spreadRecovery++;
            bool cloaked = Player.GetModPlayer<TF2Player>().Cloaked;
            NPC.Opacity = !cloaked ? 1f : 0.5f;
            NPC.immortal = cloaked;
            NPC.netUpdate = true;
        }
