...
namespace TF2.Content.NPCs.TownNPCs
{
    ...
    public class SaxtonHale : ModNPC
    {
        ...
        public static void CreateMannCoStore()
        {
            ...
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<ScoutBuddy>(), 1.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<SoldierBuddy>(), 4.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<PyroBuddy>(), 3.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<DemomanBuddy>(), 2.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<HeavyBuddy>(), 4.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<EngineerBuddy>(), 3.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<MedicBuddy>(), 4.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<SniperBuddy>(), 2.99f);
            AddShopItem(true, MannCoStoreCategory.Buddy, ModContent.ItemType<SpyBuddy>(), 2.99f);
            ...
            AddShopItem(true, MannCoStoreCategory.Module, ModContent.ItemType<RegenerationModule>(), 2.49f);
            AddShopItem(true, MannCoStoreCategory.Module, ModContent.ItemType<PhoenixModule>(), 2.49f);
            AddShopItem(true, MannCoStoreCategory.Module, ModContent.ItemType<MarineModule>(), 2.49f);
            AddShopItem(true, MannCoStoreCategory.Module, ModContent.ItemType<NinjaModule>(), 2.49f);
        ...
        public override void AI()
        {
            ...
            if (!foundTarget && ai >= TF2.Time(1) && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                if (foundTarget)
                {
                    ...
                    if ((targetCenter - NPC.Center).Y <= 0f)
                        NPC.velocity = new Vector2(25f * direction, -15f);
                    Projectile projectile = TF2.CreateProjectile(null, projectileSource, NPC.Center, shootVel * speed, type, damage, 0f, Main.myPlayer, 0f, 0f).Projectile;
