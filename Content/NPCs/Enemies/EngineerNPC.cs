...
namespace TF2.Content.NPCs.Enemies
{
    ...
    {
        protected override Asset<Texture2D> Spritesheet => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/EngineerNPC");

        protected override Asset<Texture2D> SpritesheetReverse => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/EngineerNPC_Reverse");
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) => bestiaryEntry.Info.AddRange([
                ...
                new FlavorTextBestiaryInfoElement(Language.GetTextValue("TF2.Bestiary.Engineer")),
            ]);
