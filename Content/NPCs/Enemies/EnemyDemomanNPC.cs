...
namespace TF2.Content.NPCs.Enemies
{
    ...
    {
        protected override Asset<Texture2D> Spritesheet => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/EnemyDemomanNPC");

        protected override Asset<Texture2D> SpritesheetReverse => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/EnemyDemomanNPC_Reverse");
        ...
        protected override void EnemyAttack(Player target)
        {
            ...
            if (AttackTimer >= AttackSpeed && Ammo > 0)
            {
                ...
                float speed = 12.5f;
                int type = ModContent.ProjectileType<EnemyGrenade>();
