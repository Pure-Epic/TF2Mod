...
namespace TF2.Content.NPCs.Enemies
{
    ...
    {
        protected override Asset<Texture2D> Spritesheet => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/PyroNPC");

        protected override Asset<Texture2D> SpritesheetReverse => ModContent.Request<Texture2D>("TF2/Content/NPCs/Enemies/PyroNPC_Reverse");
        ...
        protected override void EnemyAttack(Player target)
        {
            ...
            if (AttackTimer >= AttackSpeed && Ammo > 0)
            {
                ...
                float speed = 10f;
                int type = ModContent.ProjectileType<EnemyFireNPC>();
