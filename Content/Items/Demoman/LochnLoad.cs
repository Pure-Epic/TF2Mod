...
namespace TF2.Content.Items.Demoman
{
    public class LochnLoad : TF2Weapon
    {
        protected override void WeaponStatistics()
        {
            ...
            SetWeaponAttackSound("TF2/Content/Sounds/SFX/loch_n_load_shoot");
            SetWeaponAttackIntervals(maxAmmo: 3, reloadTime: 0.6, initialReloadTime: 1.24, reloadSoundPath: "TF2/Content/Sounds/SFX/grenade_launcher_reload");
