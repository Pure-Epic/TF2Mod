...
namespace TF2.Content.Items
{
    ...
    {
        // This is a damage class designed to demonstrate all the current functionality of the feature and explain how to create one of your own, should you need one.
        ...
        public override void SetStaticDefaults() => ClassName.SetDefault("mercenary damage");
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            // player.GetCritChance<TF2DamageClass>() -= 4;
            // player.GetArmorPenetration<TF2DamageClass>() += 10000; // Don't do this to ignore defense
