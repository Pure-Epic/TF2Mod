...
namespace TF2.Content.Items.Weapons.Demoman
{
    public class GrenadeLauncher : TF2Weapon
    {
        protected override void WeaponStatistics()
        {
            ...
            SetWeaponAttackSound("TF2/Content/Sounds/SFX/Weapons/grenade_launcher_shoot");
            SetWeaponAttackIntervals(maxAmmo: 4, maxReserve: 16, reloadTime: 0.6, initialReloadTime: 1.24, reloadSoundPath: "TF2/Content/Sounds/SFX/Weapons/grenade_launcher_reload");
        }
    }
}