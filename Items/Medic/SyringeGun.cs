...
namespace TF2.Items.Medic
{
    public class SyringeGun : TF2Weapon
	{
		...
		public override void SafeSetDefaults() 
		{
			...
			Item.noMelee = true;
			Item.UseSound = new SoundStyle("TF2/Sounds/SFX/syringegun_shoot"); ;
			Item.autoReuse = true;
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
		{
			...
			ammoInClip -= 1;
			Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<Syringe>(), damage, knockback, player.whoAmI);
