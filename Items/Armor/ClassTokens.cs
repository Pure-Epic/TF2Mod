...
namespace TF2.Items.Armor
{
    ...
    public class ScoutClass : ClassToken
    {
        public override void Load()
        {
            ...
            EquipLoader.AddEquipTexture(Mod, $"{Texture}_{EquipType.Wings}", EquipType.Wings, this); //, equipTexture: new ScoutFront());
        }
    ...
    public class MedicClass : ClassToken
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (timer >= 60)
            {
                player.statLife += (int)(3 * p.classMultiplier);
                timer = 0;
            }
        }
        private void SetupDrawing()
