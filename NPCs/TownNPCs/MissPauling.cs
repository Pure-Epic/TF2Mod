    ...
    public class MissPaulingProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("TF2/NPCs/TownNPCs/MissPauling");
        ...
        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("TF2/NPCs/TownNPCs/MissPauling_Head");
    }
}