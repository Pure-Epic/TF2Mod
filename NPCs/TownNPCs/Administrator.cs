    ...
    public class Administrator : ModNPC
    {
        ...
        public override void SetupShop(Chest shop, ref int nextSlot)
        {
            ...
            if (!Main.hardMode)
            {
                ...
                shop.item[nextSlot].shopCustomPrice = Item.buyPrice(gold: 65);
            }
            else
            {
                shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.NPCSummoners.DemomanSummon>());
            ...
            if (!Main.hardMode)
            {
                ...
                shop.item[nextSlot].shopCustomPrice = Item.buyPrice(gold: 85);
            }
            else
            {
                shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.NPCSummoners.HeavySummon>());
                shop.item[nextSlot].shopCustomPrice = Item.buyPrice(platinum: 2, gold: 50);
            }
            nextSlot++;
            ...
            if (!Main.hardMode)
            {
                ...
                shop.item[nextSlot].shopCustomPrice = Item.buyPrice(gold: 80);
            }
            else
            {
                shop.item[nextSlot].SetDefaults(ModContent.ItemType<Items.NPCSummoners.SpySummon>());
                shop.item[nextSlot].shopCustomPrice = Item.buyPrice(platinum: 2, gold: 25);
            }
        }
    ...
    public class AdministratorProfile : ITownNPCProfile
    {
        ...
        public Asset<Texture2D> GetTextureNPCShouldUse(NPC npc)
        {
            if (npc.IsABestiaryIconDummy && !npc.ForcePartyHatOn)
                return ModContent.Request<Texture2D>("TF2/NPCs/TownNPCs/Administrator");
        ...
        public int GetHeadTextureIndex(NPC npc) => ModContent.GetModHeadSlot("TF2/NPCs/TownNPCs/Administrator_Head");
    }
}