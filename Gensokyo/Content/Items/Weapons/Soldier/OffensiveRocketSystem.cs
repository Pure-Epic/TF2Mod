...
namespace TF2.Gensokyo.Content.Items.Weapons.Soldier
{
    ...
    public class OffensiveRocketSystem : TF2Weapon
    {
        protected override void WeaponStatistics()
        {
            ...
            SetWeaponAttackIntervals(maxAmmo: 6, maxReserve: 18, reloadTime: 0.4, initialReloadTime: 0.46666, reloadSoundPath: "TF2/Content/Sounds/SFX/Weapons/rocket_reload");
